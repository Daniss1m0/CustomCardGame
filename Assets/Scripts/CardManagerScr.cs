...
public struct Card
{
    ...
    public Card(string name, string logoPath, int attack, int defense, int manacost,
                AbilityType abilityType = 0, SpellType spellType = 0, int spellVal = 0, TargetType targetType = 0)
    {
        Name = name;
...
public class CardManagerScr : MonoBehaviour
{
    public void Awake()
    {
        ...
        CardManager.AllCards.Add(new Card("HEAL_ALLY_FIELD_CARDS", "Sprites/Cards/health1yCards", 0, 0, 2, 0,
        ...
        CardManager.AllCards.Add(new Card("HEAL_ALLY_HERO", "Sprites/Cards/health1yHero", 0, 0, 2, 0,
        ...
        CardManager.AllCards.Add(new Card("HEAL_ALLY_CARD", "Sprites/Cards/health1yCard", 0, 0, 2, 0,
